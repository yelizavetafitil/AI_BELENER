    ...
    *,
    ...
    if not refs:
        ...
        lines.append(
            ...
            '<th class="th-2line"><span>Введен</span><br><span>Стройдок</span></th>'
            '<th class="th-2line"><span>Отменен</span><br><span>Стройдок</span></th>'
            '<th class="th-2line"><span>Введен</span><br><span>ТНПА</span></th>'
            '<th class="th-2line"><span>Отменен</span><br><span>ТНПА</span></th>'
            "<th>Статус</th>"
        )
